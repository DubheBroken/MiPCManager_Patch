...
tr_table!(tr_zh, {
    ...
    "patch.hotkey.detail" => "鼠标快捷键（含两个侧键）",
    ...
    "patch.hotkey.desc" => "允许将中键、右键及两个鼠标侧键设为快捷键",
    ...
    "gui.op.hotkey.apply" => "鼠标快捷键",
    "gui.op.hotkey.revert" => "鼠标快捷键·还原",
    ...
    "tui.shortcuts.install" => "Tab 切换面板  Enter 安装同目录超级小爱  R 刷新  Q 退出",
    ...
    "tui.install.desc" => "工具自动识别安装包类型，安装到正确位置并处理残留清理",
    ...
    "tui.install.xiaoai.enter" => "按 Enter：安装 Patcher 同目录中唯一的超级小爱安装包并注入补丁",
    ...
    "tui.op.hotkey.apply" => "鼠标快捷键 · 应用",
    "tui.op.hotkey.revert" => "鼠标快捷键 · 还原",
...
tr_table!(tr_en, {
    ...
    "patch.hotkey.detail" => "Mouse Hotkeys (including two side buttons)",
    ...
    "patch.hotkey.desc" => "Use middle, right, and both mouse side buttons as hotkeys",
    ...
    "gui.op.hotkey.apply" => "Mouse Hotkeys",
    "gui.op.hotkey.revert" => "Mouse Hotkeys · Revert",
    ...
    "tui.shortcuts.install" => "Tab Panel  Enter Install Local Super XiaoAI  R Refresh  Q Quit",
    ...
    "tui.install.desc" => "Auto-detects installer type, installs to correct location, handles cleanup",
    ...
    "tui.install.hint.xiaoai1" => "  MiPCM_CLI xiaoai install --url https://...",
    "tui.install.hint.xiaoai2" => "  MiPCM_CLI xiaoai install --installer XiaoaiAgent_Setup.exe",
    "tui.install.xiaoai.enter" => "Press Enter: install the only Super XiaoAI package beside Patcher and inject the patch",
    ...
    "tui.op.hotkey.apply" => "Mouse Hotkeys · Apply",
    "tui.op.hotkey.revert" => "Mouse Hotkeys · Revert",
