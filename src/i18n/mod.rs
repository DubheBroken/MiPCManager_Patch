...
tr_table!(tr_zh, {
    ...
    "tui.shortcuts.install" => "Tab 切换面板  安装请用命令行  MiPCM_CLI install ...  R 刷新  Q 退出",
...
tr_table!(tr_en, {
    ...
    "tui.shortcuts.install" => "Tab Panel  Use CLI to install  MiPCM_CLI install ...  R Refresh  Q Quit",
